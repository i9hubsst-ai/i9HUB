...
"[project]/app/actions/data:88a885 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"7c9621f32fabf685ce15d97f61e1eed06098940321":"saveAnswer"},"app/actions/assessments.ts",""] */ __turbopack_context__.s([
    "saveAnswer",
    ()=>saveAnswer
]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$03b674__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:03b674 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$6d7f02__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:6d7f02 [app-client] (ecmascript) <text/javascript>");
;
...
function EvidenceUpload(param) {
    ...
    const handleFileSelect = async (files)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$03b674__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["uploadEvidence"])(assessmentId, answerId, formData);
        if (result.error) {
    ...
    const handleDelete = async (evidenceId)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$6d7f02__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteEvidence"])(evidenceId, assessmentId);
        if (result.error) {
            setError(result.error);
        } else {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$88a885__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:88a885 [app-client] (ecmascript) <text/javascript>");
...
function DiagnosticSections(param) {
    ...
    const handleAnswer = async (questionId, value, requiresJustification, requiresEvidence)=>{
        ...
        if (!requiresJustification && !requiresEvidence) {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$88a885__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveAnswer"])(assessment.id, questionId, value, undefined);
            if ('error' in result) {
                setErrors({
                    ...errors,
    ...
    const handleSaveResponse = async (questionId, requiresJustification)=>{
        ...
        setSaving(questionId);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$88a885__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveAnswer"])(assessment.id, questionId, currentAnswer.value, currentAnswer.justification.trim() || undefined);
        if ('error' in result) {
            setErrors({
                ...errors,
                [questionId]: result.error
...
//# sourceMappingURL=_095c2ca8._.js.map