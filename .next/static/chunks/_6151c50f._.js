...
"[project]/app/actions/data:9cac0a [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"7c0c67038d0ffef7bc03bffe106753447dd1eba643":"saveAnswer"},"app/actions/assessments.ts",""] */ __turbopack_context__.s([
    "saveAnswer",
    ()=>saveAnswer
]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$ce245a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:ce245a [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$7bbfbd__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:7bbfbd [app-client] (ecmascript) <text/javascript>");
;
...
function EvidenceUpload(param) {
    ...
    const handleFileSelect = async (files)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$ce245a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["uploadEvidence"])(assessmentId, answerId, formData);
        if (result.error) {
    ...
    const handleDelete = async (evidenceId)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$7bbfbd__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteEvidence"])(evidenceId, assessmentId);
        if (result.error) {
            setError(result.error);
        } else {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$9cac0a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:9cac0a [app-client] (ecmascript) <text/javascript>");
...
function DiagnosticSections(param) {
    ...
    const handleAnswer = async (questionId, value, requiresJustification, requiresEvidence)=>{
        ...
        if (!requiresJustification && !requiresEvidence) {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$9cac0a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveAnswer"])(assessment.id, questionId, value, undefined);
            if ('error' in result) {
                setErrors({
                    ...errors,
    ...
    const handleSaveResponse = async (questionId, requiresJustification)=>{
        ...
        setSaving(questionId);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$9cac0a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveAnswer"])(assessment.id, questionId, currentAnswer.value, currentAnswer.justification.trim() || undefined);
        setSaving(null);
        if ('error' in result) {
            setErrors({
                ...errors,
...
//# sourceMappingURL=_6151c50f._.js.map