...
"[project]/app/actions/data:5dd176 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$5dd176__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:5dd176 [app-client] (ecmascript) <text/javascript>");
;
...
function InviteUserDialog(param) {
    ...
    async function handleSubmit(e) {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$5dd176__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["inviteUser"])(companyId, formData);
        if (result.error) {
...
"[project]/app/actions/data:c043cb [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/select.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$label$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/label.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$c043cb__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:c043cb [app-client] (ecmascript) <text/javascript>");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function EditUserRoleDialog(param) {
    ...
    async function handleSubmit(e) {
        ...
        setError('');
        setSuccess(false);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$c043cb__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateUserRole"])(user.id, selectedRole);
        if (result.error) {
            setError(result.error);
            setLoading(false);
        } else {
...
"[project]/app/actions/data:0084d7 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/actions/data:386520 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$0084d7__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:0084d7 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$386520__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:386520 [app-client] (ecmascript) <text/javascript>");
...
function UsersList(param) {
    ...
    async function handleResendInvite(user) {
        setLoading(user.id);
        setError('');
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$0084d7__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["resendInvite"])(user.id);
        if (result.error) {
            setError(result.error);
        }
        setLoading(null);
    ...
    async function handleRemoveUser() {
        ...
        setError('');
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$386520__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["removeUserFromCompany"])(removingUser.id);
        if (result.error) {
            setError(result.error);
        } else {
...
//# sourceMappingURL=_951f34f1._.js.map