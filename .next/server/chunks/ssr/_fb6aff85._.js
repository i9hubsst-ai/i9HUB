...
"[project]/app/actions/data:88a885 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$03b674__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:03b674 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$6d7f02__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:6d7f02 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function EvidenceUpload({ assessmentId, answerId, existingEvidences = [], disabled = false }) {
    ...
    const handleFileSelect = async (files)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$03b674__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["uploadEvidence"])(assessmentId, answerId, formData);
        if (result.error) {
    ...
    const handleDelete = async (evidenceId)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$6d7f02__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteEvidence"])(evidenceId, assessmentId);
        if (result.error) {
            setError(result.error);
        } else {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$88a885__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:88a885 [app-ssr] (ecmascript) <text/javascript>");
...
function DiagnosticSections({ assessment }) {
    ...
    const handleAnswer = async (questionId, value, requiresJustification, requiresEvidence)=>{
        ...
        if (!requiresJustification && !requiresEvidence) {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$88a885__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveAnswer"])(assessment.id, questionId, value, undefined);
            if ('error' in result) {
                setErrors({
                    ...errors,
    ...
    const handleSaveResponse = async (questionId, requiresJustification)=>{
        ...
        setSaving(questionId);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$88a885__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveAnswer"])(assessment.id, questionId, currentAnswer.value, currentAnswer.justification.trim() || undefined);
        if ('error' in result) {
            setErrors({
                ...errors,
                [questionId]: result.error
...
//# sourceMappingURL=_fb6aff85._.js.map