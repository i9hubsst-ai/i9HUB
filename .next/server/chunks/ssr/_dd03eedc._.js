...
"[project]/app/actions/data:14a0c7 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$14a0c7__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:14a0c7 [app-ssr] (ecmascript) <text/javascript>");
...
function DiagnosticSections({ assessment }) {
    ...
    const handleAnswer = async (questionId, value, requiresJustification)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$14a0c7__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveAnswer"])(assessment.id, questionId, value, currentAnswer.justification.trim() || undefined);
        if ('error' in result) {
            setErrors({
                ...errors,
    ...
    const handleJustificationSave = async (questionId, value)=>{
        ...
        setSaving(questionId);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$14a0c7__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveAnswer"])(assessment.id, questionId, currentAnswer.value, currentAnswer.justification.trim() || undefined);
        if ('error' in result) {
            setErrors({
                ...errors,
                [questionId]: result.error
...
//# sourceMappingURL=_dd03eedc._.js.map