...
"[project]/app/actions/data:73ef36 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"60892d0d8038d658b98b3b8c480adcf64a50d67b70":"inviteUser"},"app/actions/users.ts",""] */ __turbopack_context__.s([
    "inviteUser",
    ()=>inviteUser
]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$73ef36__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:73ef36 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function InviteUserDialog({ companies }) {
    ...
    async function handleSubmit(e) {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$73ef36__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["inviteUser"])(companyId, formData);
        if (result.error) {
...
"[project]/app/actions/data:acc320 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"602cbe5b903ac7a9fbf48285b7dd437012403f985f":"updateUserRole"},"app/actions/users.ts",""] */ __turbopack_context__.s([
    "updateUserRole",
    ()=>updateUserRole
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$client$2d$wrapper$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/webpack/loaders/next-flight-loader/action-client-wrapper.js [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/select.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$label$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/label.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$acc320__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:acc320 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function EditUserRoleDialog({ open, onOpenChange, user }) {
    ...
    async function handleSubmit(e) {
        ...
        setError('');
        setSuccess(false);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$acc320__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateUserRole"])(user.id, selectedRole);
        if (result.error) {
            setError(result.error);
            setLoading(false);
        } else {
...
"[project]/app/actions/data:f4cb5f [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"607268ae643b83e9504df31ac1ce8906c7ee0a2515":"updateUserProfile"},"app/actions/users.ts",""] */ __turbopack_context__.s([
    "updateUserProfile",
    ()=>updateUserProfile
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$client$2d$wrapper$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/webpack/loaders/next-flight-loader/action-client-wrapper.js [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$f4cb5f__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:f4cb5f [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function EditUserProfileDialog({ user, open, onOpenChange }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$f4cb5f__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateUserProfile"])(user.userId, {
...
"[project]/app/actions/data:1b241e [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"4093c8a003ebcad5a4ed935db7ccac0049da29f097":"resendInvite"},"app/actions/users.ts",""] */ __turbopack_context__.s([
    "resendInvite",
    ()=>resendInvite
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$client$2d$wrapper$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/webpack/loaders/next-flight-loader/action-client-wrapper.js [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$1b241e__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:1b241e [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$6e2d0e__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:6e2d0e [app-ssr] (ecmascript) <text/javascript>");
...
function UsersList({ users }) {
    ...
    async function handleResendInvite(user) {
        setLoading(user.id);
        setError('');
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$1b241e__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["resendInvite"])(user.id);
        if (result.error) {
            setError(result.error);
        }
        setLoading(null);
    ...
    async function handleRemoveUser() {
        ...
        setError('');
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$6e2d0e__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["removeUserFromCompany"])(removingUser.id);
        if (result.error) {
            setError(result.error);
        } else {
...
//# sourceMappingURL=_9a2c1e84._.js.map