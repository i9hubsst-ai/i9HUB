...
"[project]/app/actions/data:7cad83 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"6035685bfd84f446df5c61bf83a0e2ac0f93bdeee4":"updateTemplate"},"app/actions/templates.ts",""] */ __turbopack_context__.s([
    "updateTemplate",
    ()=>updateTemplate
]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$7cad83__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:7cad83 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function TemplateEditForm({ template }) {
    ...
    const handleSave = async ()=>{
        ...
        setSaving(true);
        setError('');
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$7cad83__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateTemplate"])(template.id, {
            name,
            description,
...
//# sourceMappingURL=_3400398e._.js.map