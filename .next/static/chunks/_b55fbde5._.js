...
"[project]/app/actions/data:a540d7 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"7c6e331153bedb0e821a520a2c2b33889a25a60522":"saveAnswer"},"app/actions/assessments.ts",""] */ __turbopack_context__.s([
    "saveAnswer",
    ()=>saveAnswer
]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$cef436__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:cef436 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$b6fe98__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:b6fe98 [app-client] (ecmascript) <text/javascript>");
;
...
function EvidenceUpload(param) {
    ...
    const handleFileSelect = async (files)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$cef436__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["uploadEvidence"])(assessmentId, answerId, formData);
        if (result.error) {
    ...
    const handleDelete = async (evidenceId)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$b6fe98__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteEvidence"])(evidenceId, assessmentId);
        if (result.error) {
            setError(result.error);
        } else {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: ()=>{
                                    ...
                                    if (evidence.mimeType.startsWith('image/') || evidence.mimeType === 'application/pdf') {
                                        ...
                                        if (win) {
                                            win.document.write("\n                        <html>\n                          <head>\n                            <title>".concat(evidence.fileName, "</title>\n                            <style>\n                              body { margin: 0; display: flex; justify-content: center; align-items: center; min-height: 100vh; background: #f3f4f6; }\n                              img { max-width: 100%; max-height: 100vh; object-fit: contain; }\n                              iframe { width: 100vw; height: 100vh; border: none; }\n                            </style>\n                          </head>\n                          <body>\n                            ").concat(evidence.mimeType.startsWith('image/') ? '<img src="'.concat(evidence.fileUrl, '" alt="').concat(evidence.fileName, '" />') : '<iframe src="'.concat(evidence.fileUrl, '"></iframe>'), "\n                          </body>\n                        </html>\n                      "));
                                        }
                                    } else {
                                        link.click();
                                    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$a540d7__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:a540d7 [app-client] (ecmascript) <text/javascript>");
...
function DiagnosticSections(param) {
    ...
    const handleAnswer = async (questionId, value, requiresJustification, requiresEvidence)=>{
        ...
        if (!requiresJustification && !requiresEvidence) {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$a540d7__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveAnswer"])(assessment.id, questionId, value, undefined);
            if ('error' in result) {
                setErrors({
                    ...errors,
    ...
    const handleSaveResponse = async (questionId, requiresJustification)=>{
        ...
        setSaving(questionId);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$a540d7__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveAnswer"])(assessment.id, questionId, currentAnswer.value, currentAnswer.justification.trim() || undefined);
        setSaving(null);
        if ('error' in result) {
            setErrors({
                ...errors,
        ...
        children: [
            ...
            assessment.template.sections.map((section)=>{
                ...
                const sectionAnswers = section.questions.filter((q)=>{
                    ...
                    return (answer === null || answer === void 0 ? void 0 : answer.value) !== undefined && (answer === null || answer === void 0 ? void 0 : answer.value) !== null;
                });
                const progressText = "".concat(sectionAnswers.length, "/").concat(section.questions.length, " respondidas");
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
...
_s(DiagnosticSections, "oRrA/Ek1arORTVOeswLV/Mo+JzA=");
...
function DiagnosticFindings(param) {
    ...
    if (findings.length === 0) {
        const isCompleted = assessment.id && ![
            'DRAFT',
            'IN_PROGRESS'
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: isCompleted ? 'Todas as respostas estão conformes. O diagnóstico não identificou não conformidades.' : 'Os achados serão gerados automaticamente quando você finalizar o diagnóstico. Achados são criados para: respostas "Não" em perguntas booleanas ou pontuação ≤ 3 em perguntas de escala.'
                        }, void 0, false, {
                            fileName: "[project]/components/dashboard/diagnostic-findings.tsx",
                            lineNumber: 80,
                            columnNumber: 13
...
"[project]/components/dashboard/back-to-diagnostics.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$arrow$2d$left$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ArrowLeft$3e$__["ArrowLeft"], {
                ...
                fileName: "[project]/components/dashboard/back-to-diagnostics.tsx",
                lineNumber: 17,
                columnNumber: 7
            }, this),
...
_s(BackToDiagnostics, "fN7XvhJ+p5oE6+Xlo0NJmXpxjC8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = BackToDiagnostics;
var _c;
__turbopack_context__.k.register(_c, "BackToDiagnostics");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_b55fbde5._.js.map